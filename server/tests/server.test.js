...
describe('PATCH /todos/:id', () => {
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    ...
    // 200, text is chnaged, o\completed false, completedAt null, toNotExist
      var hexId = todos[1]._id.toHexString();
      var text = 'This should be more new text';
...
describe('POST /users', () => {
  ...
  it('should return validation errors if request invalid', (done) => {
    // invalid email, password return 400
    var email = 'fdfdfff';
    var password = 'aaa';
